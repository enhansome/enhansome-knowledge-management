...
* [Trilium Notes](https://github.com/zadam/trilium) ⭐ 37,818 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-13 - A hierarchical note taking application with a focus on building large personal knowledge bases.
* [Screenpipe](https://github.com/mediar-ai/screenpipe) ⭐ 21,555 | 🐛 31 | 🌐 Rust | 📅 2026-09-13 - 24/7 local AI screen & mic recording for knowledge capture. Build AI apps with full context. Works with Ollama.
* [NoteGen](https://github.com/codexu/note-gen) ⭐ 12,795 | 🐛 93 | 🌐 TypeScript | 📅 2026-09-12 - An open-source, local-first Markdown note-taking app that helps capture scattered information and organize it into structured notes with AI.
* [Org-roam](https://github.com/org-roam/org-roam) ⭐ 6,025 | 🐛 88 | 🌐 Emacs Lisp | 📅 2026-04-27 - A Roam replica built on top of the all-powerful [Org-mode](https://orgmode.org/) for Emacs.
* [ThoughtDAG](https://github.com/chenxiachan/thoughtdag) ⭐ 440 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-12 - An open-source, local-first visual workspace for branching and managing LLM conversations, where graph edges determine the context sent to the model.
...
* [Nodus](https://github.com/Drakonis96/nodus) ⭐ 180 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-13 - Desktop workspace for researchers, teachers, and students to connect sources, notes, data, ideas, and learning materials.
...
* [MindBase](https://github.com/frankchu91/mindbase-llm-wiki) ⭐ 102 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-24 - An open-source implementation of Karpathy's LLM Wiki idea: an AI maintains a persistent markdown wiki from your notes and sources — approval-gated updates, contradiction linting, runs on free local models.
...
* [OATS](https://github.com/ariso-ai/oats) ⭐ 28 | 🐛 12 | 🌐 Rust | 📅 2026-09-13 - Open-source macOS meeting-notes app that records conversations, transcribes them, labels speakers, and generates Markdown notes with an optional fully offline mode.
...
* [NetworkX](https://github.com/networkx/networkx) ⭐ 17,255 | 🐛 308 | 🌐 Python | 📅 2026-09-12 - A Python package for the creation, manipulation and study of complex networks.
* [jsMind](https://github.com/hizzgdev/jsmind) ⭐ 3,795 | 🐛 1 | 🌐 JavaScript | 📅 2026-05-18 - A JavaScript library for mind map visualizations.
...
* [ArchiveBox](https://github.com/pirate/ArchiveBox) ⭐ 28,374 | 🐛 159 | 🌐 Python | 📅 2026-09-11 - An open source self-hosted internet archiving solution.
