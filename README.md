...
* [Trilium Notes](https://github.com/zadam/trilium) ⭐ 37,785 | 🐛 684 | 🌐 TypeScript | 📅 2026-09-10 - A hierarchical note taking application with a focus on building large personal knowledge bases.
* [Screenpipe](https://github.com/mediar-ai/screenpipe) ⭐ 21,517 | 🐛 31 | 🌐 Rust | 📅 2026-09-10 - 24/7 local AI screen & mic recording for knowledge capture. Build AI apps with full context. Works with Ollama.
* [NoteGen](https://github.com/codexu/note-gen) ⭐ 12,782 | 🐛 97 | 🌐 TypeScript | 📅 2026-09-10 - An open-source, local-first Markdown note-taking app that helps capture scattered information and organize it into structured notes with AI.
* [Org-roam](https://github.com/org-roam/org-roam) ⭐ 6,023 | 🐛 88 | 🌐 Emacs Lisp | 📅 2026-04-27 - A Roam replica built on top of the all-powerful [Org-mode](https://orgmode.org/) for Emacs.
* [ThoughtDAG](https://github.com/chenxiachan/thoughtdag) ⭐ 413 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-10 - An open-source, local-first visual workspace for branching and managing LLM conversations, where graph edges determine the context sent to the model.
...
* [Nodus](https://github.com/Drakonis96/nodus) ⭐ 129 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-10 - Desktop workspace for researchers, teachers, and students to connect sources, notes, data, ideas, and learning materials.
...
* [OATS](https://github.com/ariso-ai/oats) ⭐ 26 | 🐛 20 | 🌐 Rust | 📅 2026-09-10 - Open-source macOS meeting-notes app that records conversations, transcribes them, labels speakers, and generates Markdown notes with an optional fully offline mode.
* [Persona](https://github.com/jayamitkatariya/personacli) ⭐ 20 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-09 - Local-first personal workspace: notes, tasks and AI chat. Plain markdown files, no accounts, no cloud. MIT.
* [Persona](https://github.com/jayamitkatariya/personacli) ⭐ 20 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-09 - Local-first personal workspace: write notes, track tasks, chat with an AI that knows your files — all plain Markdown.
...
* [NetworkX](https://github.com/networkx/networkx) ⭐ 17,254 | 🐛 313 | 🌐 Python | 📅 2026-09-09 - A Python package for the creation, manipulation and study of complex networks.
...
* [ArchiveBox](https://github.com/pirate/ArchiveBox) ⭐ 28,261 | 🐛 159 | 🌐 Python | 📅 2026-09-07 - An open source self-hosted internet archiving solution.
...
* [Second-Brain](https://github.com/KasperZutterman/Second-Brain) ⭐ 1,837 | 🐛 2 | 📅 2026-06-30 - A curated list of awesome public Zettelkastens / Second Brains / Digital Gardens.
