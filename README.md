...
* [Trilium Notes](https://github.com/zadam/trilium) ⭐ 37,997 | 🐛 665 | 🌐 TypeScript | 📅 2026-09-26 - A hierarchical note taking application with a focus on building large personal knowledge bases.
* [Screenpipe](https://github.com/mediar-ai/screenpipe) ⭐ 21,716 | 🐛 34 | 🌐 Rust | 📅 2026-09-26 - 24/7 local AI screen & mic recording for knowledge capture. Build AI apps with full context. Works with Ollama.
* [NoteGen](https://github.com/codexu/note-gen) ⭐ 12,842 | 🐛 103 | 🌐 TypeScript | 📅 2026-09-26 - An open-source, local-first Markdown note-taking app that helps capture scattered information and organize it into structured notes with AI.
...
* [ThoughtDAG](https://github.com/chenxiachan/thoughtdag) ⭐ 492 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-26 - An open-source, local-first visual workspace for branching and managing LLM conversations, where graph edges determine the context sent to the model.
...
* [Nodus](https://github.com/Drakonis96/nodus) ⭐ 263 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-26 - Desktop workspace for researchers, teachers, and students to connect sources, notes, data, ideas, and learning materials.
...
* [MindBase](https://github.com/frankchu91/mindbase-llm-wiki) ⭐ 122 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-14 - An open-source implementation of Karpathy's LLM Wiki idea: an AI maintains a persistent markdown wiki from your notes and sources — approval-gated updates, contradiction linting, runs on free local models.
* [OATS](https://github.com/ariso-ai/oats) ⭐ 84 | 🐛 20 | 🌐 Rust | 📅 2026-09-24 - Open-source macOS meeting-notes app that records conversations, transcribes them, labels speakers, and generates Markdown notes with an optional fully offline mode.
...
* [Persona](https://github.com/jayamitkatariya/personacli) ⭐ 22 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-09 - Local-first personal workspace: notes, tasks and AI chat. Plain markdown files, no accounts, no cloud. MIT.
* [Persona](https://github.com/jayamitkatariya/personacli) ⭐ 22 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-09 - Local-first personal workspace: write notes, track tasks, chat with an AI that knows your files — all plain Markdown.
...
* [TideMind](https://github.com/SawyerHan-AI/TideMind) ⭐ 11 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-23 - Open-source AI memory layer with a living knowledge graph. Connects AI tools and notes via MCP. Local-first, SQLite-backed.
...
* [NetworkX](https://github.com/networkx/networkx) ⭐ 17,289 | 🐛 306 | 🌐 Python | 📅 2026-09-25 - A Python package for the creation, manipulation and study of complex networks.
...
* [Awesome Knowledge Graph](https://github.com/shaoxiongji/awesome-knowledge-graph) ⭐ 1,797 | 🐛 0 | 🌐 JavaScript | 📅 2022-10-07 - A curated collection of research on knowledge graphs.
...
* [ArchiveBox](https://github.com/pirate/ArchiveBox) ⭐ 28,619 | 🐛 165 | 🌐 Python | 📅 2026-09-26 - An open source self-hosted internet archiving solution.
...
* [Athens](https://github.com/athensresearch/athens) ⭐ 6,297 | 🐛 318 | 🌐 Clojure | 📅 2023-02-03 - Open-source tool to link thoughts, reference key observations, and network your knowledge using a user-friendly outliner and knowledge graph (last updated: **July 26, 2021**).
