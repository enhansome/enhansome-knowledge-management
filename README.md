...
* [Trilium Notes](https://github.com/zadam/trilium) ⭐ 37,613 | 🐛 695 | 🌐 TypeScript | 📅 2026-08-27 - A hierarchical note taking application with a focus on building large personal knowledge bases.
* [Screenpipe](https://github.com/mediar-ai/screenpipe) ⭐ 21,265 | 🐛 86 | 🌐 Rust | 📅 2026-08-27 - 24/7 local AI screen & mic recording for knowledge capture. Build AI apps with full context. Works with Ollama.
* [NoteGen](https://github.com/codexu/note-gen) ⭐ 12,692 | 🐛 118 | 🌐 TypeScript | 📅 2026-08-26 - An open-source, local-first Markdown note-taking app that helps capture scattered information and organize it into structured notes with AI.
...
* [ThoughtDAG](https://github.com/chenxiachan/thoughtdag) ⭐ 293 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-25 - An open-source, local-first visual workspace for branching and managing LLM conversations, where graph edges determine the context sent to the model.
...
* [Nodus](https://github.com/Drakonis96/nodus) ⭐ 100 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-27 - Desktop workspace for researchers, teachers, and students to connect sources, notes, data, ideas, and learning materials.
...
* [lifeos-cli](https://github.com/liujuanjuan1984/lifeos-cli) ⭐ 11 | 🐛 4 | 🌐 Python | 📅 2026-08-27 - A terminal-native LifeOS for structuring notes, tasks, habits, events, schedules, and timelogs in one CLI workflow.
...
* [NetworkX](https://github.com/networkx/networkx) ⭐ 17,228 | 🐛 320 | 🌐 Python | 📅 2026-08-27 - A Python package for the creation, manipulation and study of complex networks.
...
* [ArchiveBox](https://github.com/pirate/ArchiveBox) ⭐ 28,194 | 🐛 172 | 🌐 Python | 📅 2026-08-27 - An open source self-hosted internet archiving solution.
